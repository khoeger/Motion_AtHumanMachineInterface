...
, 			{
				"box" : 				{
					...
					"fontsize" : 13.0,
					"id" : "obj-379",
					"items" : [ "None", ",", "Speakers (Realtek(R) Audio)", ",", "VoiceMeeter VAIO3 Input (VB-Aud", ",", "Speakers (VB-Audio Hi-Fi Cable)", ",", "VoiceMeeter Input (VB-Audio Voi", ",", "VoiceMeeter Aux Input (VB-Audio", ",", "VoiceMeeter VAIO3 Input (VB-Aud" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
